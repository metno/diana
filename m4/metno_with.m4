# -*- autoconf -*-
#
# $Id: metno_with.m4 2766 2009-09-14 04:44:08Z dages $
#
# SYNOPSIS
#
...
AC_DEFUN([METNO_IF_WITH_ANY], [
	...
	AS_IF([test x$with_[]COMPONENT = xyes],
	    [metno_if_with_any_result=yes; break])
    ])
    AS_IF([test x$metno_if_with_any_result = xyes], [:;$2], [:;$3])
...
AC_DEFUN([METNO_IF_WITH_ALL], [
    ...
    AS_IF([test x$metno_if_with_all_result = xyes], [:;$2;], [:;$3])
