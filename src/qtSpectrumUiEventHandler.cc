...
SpectrumUiEventHandler::SpectrumUiEventHandler(SpectrumPaintable* g)
    : p(g)
{
}

bool SpectrumUiEventHandler::handleKeyEvents(QKeyEvent* ke)
{
  ...
  if (ke->key() == Qt::Key_Left) {
    ...
    p->spectrumManager()->setStation(-1);
