...
public:
  ...
  void readLog(const std::string& logpart, const std::vector<std::string>& vstr, const std::string& thisVersion, const std::string& logVersion,
               int displayWidth, int displayHeight);

  bool active;

  void applyPlotCommands(const PlotCommand_cpv& cmds);
