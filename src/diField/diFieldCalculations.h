...
bool meanValue(int nx, int ny, const std::vector<float*>& fields,
    float *fres, bool& allDefined, float undef);

bool stddevValue(int nx, int ny, const std::vector<float*>& fields,
    float *fres, bool& allDefined, float undef);

bool extremeValue(int compute, int nx, int ny, const std::vector<float*>& fields,
    float *fres, bool& allDefined, float undef);

bool probability(int compute, int nx, int ny, const std::vector<float*>& fields,
