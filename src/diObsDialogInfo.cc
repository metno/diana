...
const std::vector<ObsDialogInfo::Par> pars = {
    {"pos", ObsDialogInfo::pt_std, -1, 0, "Position", 0, 0},
    ...
    {"vs", ObsDialogInfo::pt_std, 170, 0, "speed of motion of moving observing platform", 0, 9},
    {"ds", ObsDialogInfo::pt_std, 170, 0, "direction of motion of moving observing platform", 1, 360},
